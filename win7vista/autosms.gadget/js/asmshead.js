...
function buildCarrierList(){
	...
	try {
		...
		http.send(null);
 document.getElementById("status_message").innerHTML = "Service down if carrier list empty.";	} catch (e) {alert("Get carrier list failed somehow. Service may be down."); return true;}
